...
def build_matrix_and_weights(companies, criteria):
    ...
    return np.array(matrix), np.array(weights)
...
# main function
def promethee_main(company_tables, prefParams, optimization, prefFunc, weights):
    # final results
    final_net_flows = promethee(company_tables, prefParams, optimization, prefFunc, weights)
